...
public class CalculatorPageSteps {
    ...
    public CalculatorPageSteps(TestContext context) {
        this.testContext = context;
        this.calculatorPage = new CalculatorPage(testContext.getDriver());
    }
    ...
    public void I_verify_sum(String a, String b, String result) {
        assertThat(String.format("Sum of %s and %s should be equal to %s", a, b, result), calculatorPage.sumOf(a, b),
                is(result));
    }

    @Then("^I verify that SUBTRACTION of '(.*)' and '(.*)' equals to '(.*)'$")
    public void I_verify_subs(String a, String b, String result) {
        assertThat(String.format("Subtraction of %s and %s should be equal to %s", a, b, result), calculatorPage.subOf(a, b),
                is(result));
    }
    ...
    public void I_verify_subs_multi(String a, String b, String m, String condition, String result) {
        Matcher<String> match = (condition == null) ? is(result) : not(result);
